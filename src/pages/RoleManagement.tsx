...
import { Plus, Pencil, Trash2, Shield, UserPlus, X, LayoutGrid, LayoutList, Search } from "lucide-react";
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-2xl font-semibold text-foreground">Roles & Privileges</h1>
